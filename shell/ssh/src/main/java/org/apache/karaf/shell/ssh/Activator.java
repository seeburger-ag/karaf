...
public class Activator extends BaseActivator implements ManagedService {
    ...
    protected SshServer createSshServer(SessionFactory sessionFactory) {
        ...
        String[] sigAlgorithms      = getStringArray("sigAlgorithms", "rsa,rsa-sha2-256,rsa-sha2-512,sk-ssh-ed25519@openssh.com,sk-ecdsa-sha2-nistp256@openssh.com,ssh-ed25519,ecdsa-sha2-nistp256,ecdsa-sha2-nistp384,ecdsa-sha2-nistp521");
